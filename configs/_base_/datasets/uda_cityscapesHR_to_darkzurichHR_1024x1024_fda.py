...
cityscapes_darkzurich_train_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        data_root_target='data/dark_zurich/',
        classes=classes,
        palette=palette,
        pipeline=cityscapes_darkzurich_train_pipeline),
    val=dict(
