...
#SBATCH --output=../logs/exp_60-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized-slurm.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_60-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized-slurm.e
#
