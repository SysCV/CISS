...
#BSUB -o ../logs/exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-02.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-02.e
#
# Specify jobname.
#BSUB -J exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-02
...
export CHECKPOINT_RESUME="/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/220921_1738_csHR2acdcHR_960x960_dacs_a999_fdthings_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10_rcs001-20_hrda1-480-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_14671/latest.pth"
