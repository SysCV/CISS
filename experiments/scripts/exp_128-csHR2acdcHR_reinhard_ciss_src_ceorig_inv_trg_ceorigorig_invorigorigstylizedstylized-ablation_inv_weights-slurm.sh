...
#SBATCH --output=../logs/exp_128-csHR2acdcHR_reinhard_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_128-csHR2acdcHR_reinhard_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_128-csHR2acdcHR_reinhard_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm
