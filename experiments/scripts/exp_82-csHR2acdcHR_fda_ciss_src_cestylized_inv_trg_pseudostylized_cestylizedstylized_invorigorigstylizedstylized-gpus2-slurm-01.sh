...
#SBATCH --output=../logs/exp_82-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized-gpus2-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_82-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized-gpus2-slurm-01-01.e
#
