...
#BSUB -o ../logs/exp_67-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_67-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized.e
