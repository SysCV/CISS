...
#SBATCH --output=../logs/exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm-38-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm-38-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm
#
# Specify dependency.
...
export CHECKPOINT_RESUME="/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/220920_2054_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_b8b93/latest.pth"
