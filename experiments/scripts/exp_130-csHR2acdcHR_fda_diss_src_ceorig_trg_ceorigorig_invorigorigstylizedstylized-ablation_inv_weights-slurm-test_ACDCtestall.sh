...
#SBATCH --output=../logs/exp_130-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-25-test_ACDCtestall.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_130-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-25-test_ACDCtestall.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp130/230222_1126_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s2_99cde"
