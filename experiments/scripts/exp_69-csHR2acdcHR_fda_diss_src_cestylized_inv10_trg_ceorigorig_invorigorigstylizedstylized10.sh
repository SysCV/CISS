...
#BSUB -o ../logs/exp_69-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_69-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10.e
