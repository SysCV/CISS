...
#SBATCH --output=../logs/exp_74-csHR2acdcHR_fda_ciss_src_cestylized_ceorig-gpus2-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_74-csHR2acdcHR_fda_ciss_src_cestylized_ceorig-gpus2-slurm-01-01.e
#
