...
#SBATCH --output=../logs/exp_78-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_78-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2-slurm-01-01.e
#
