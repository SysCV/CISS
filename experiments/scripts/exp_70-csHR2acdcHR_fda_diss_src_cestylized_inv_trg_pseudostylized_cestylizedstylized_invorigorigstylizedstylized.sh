...
#BSUB -o ../logs/exp_70-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_70-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized.e
