...
#SBATCH --output=../logs/exp_81-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_81-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2-slurm-01-01.e
#
