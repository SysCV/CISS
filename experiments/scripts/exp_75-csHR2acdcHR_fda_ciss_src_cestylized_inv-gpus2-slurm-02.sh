...
#SBATCH --output=../logs/exp_75-csHR2acdcHR_fda_ciss_src_cestylized_inv-gpus2-slurm-02-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_75-csHR2acdcHR_fda_ciss_src_cestylized_inv-gpus2-slurm-02-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_75-csHR2acdcHR_fda_ciss_src_cestylized_inv-gpus2-slurm
#
# Specify dependency.
...
export CHECKPOINT_RESUME="/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/220921_1757_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_cestylized_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s2_3820a/latest.pth"
