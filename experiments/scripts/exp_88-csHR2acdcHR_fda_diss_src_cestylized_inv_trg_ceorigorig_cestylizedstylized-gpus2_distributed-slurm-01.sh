...
#SBATCH --output=../logs/exp_88-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_88-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed-slurm-01-01.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_88-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed-slurm
#
# Specify dependency.
...
# Run the experiment.
python -m torch.distributed.launch --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_port=29505 run_experiments.py --exp ${EXP_ID}
