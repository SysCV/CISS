...
#SBATCH --output=../logs/exp_117-gtaHR2csHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-slurm-04-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_117-gtaHR2csHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-slurm-04-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_117-gtaHR2csHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-slurm
