...
#SBATCH --output=../logs/exp_111-csHR2darkzurichHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-test_DarkZurichtest-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_111-csHR2darkzurichHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-test_DarkZurichtest-02.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/CISS/local-exp111/221102_1711_csHR2dzurHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_ac731"
