...
#SBATCH --output=../logs/exp_81-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2-slurm-01-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_81-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2-slurm-01-02.e
#
...
export CHECKPOINT_RESUME="/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/220921_1834_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s2_dccdd/latest.pth"
