...
#BSUB -o ../logs/exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-01.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-01.e
#
# Specify jobname.
#BSUB -J exp_73-csHR2acdcHR_960_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-02-01
