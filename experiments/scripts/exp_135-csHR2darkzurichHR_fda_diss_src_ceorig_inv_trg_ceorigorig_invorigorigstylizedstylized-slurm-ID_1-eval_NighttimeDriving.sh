...
#SBATCH --output=../logs/exp_135-csHR2darkzurichHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-02-1-eval_NighttimeDriving-04.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_135-csHR2darkzurichHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-02-1-eval_NighttimeDriving-04.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp135/230306_1111_csHR2dzurHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s1_56306"
