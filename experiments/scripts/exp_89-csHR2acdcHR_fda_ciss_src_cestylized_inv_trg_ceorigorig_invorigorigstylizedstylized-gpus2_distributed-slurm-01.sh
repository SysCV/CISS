...
#SBATCH --output=../logs/exp_89-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-gpus2_distributed-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_89-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-gpus2_distributed-slurm-01-01.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_89-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-gpus2_distributed-slurm
#
# Specify dependency.
