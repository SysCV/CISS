...
#SBATCH --output=../logs/exp_58-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized_invorigorigstylizedstylized-slurm.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_58-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized_invorigorigstylizedstylized-slurm.e
#
