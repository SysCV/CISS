...
#SBATCH --output=../logs/exp_130-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-02-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_130-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-02-%a.e
#
