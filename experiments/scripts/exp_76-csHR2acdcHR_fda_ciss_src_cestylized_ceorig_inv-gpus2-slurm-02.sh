...
#SBATCH --output=../logs/exp_76-csHR2acdcHR_fda_diss_src_cestylized_ceorig_inv-gpus2-slurm-01-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_76-csHR2acdcHR_fda_diss_src_cestylized_ceorig_inv-gpus2-slurm-01-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_76-csHR2acdcHR_fda_diss_src_cestylized_ceorig_inv-gpus2-slurm
#
# Specify dependency.
