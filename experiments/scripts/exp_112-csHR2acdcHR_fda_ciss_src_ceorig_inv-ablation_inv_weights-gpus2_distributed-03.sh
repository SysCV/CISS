...
#BSUB -o ../logs/exp_112-csHR2acdcHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-03-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_112-csHR2acdcHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-03-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_112-csHR2acdcHR_fda_diss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed[9-10]
...
export CHECKPOINT_RESUME=("/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/221102_0818_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_3ae56/latest.pth" "/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/221102_0911_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_c2670/latest.pth")
