...
#BSUB -o ../logs/exp_112-csHR2acdcHR_fda_ciss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-02-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_112-csHR2acdcHR_fda_ciss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed-02-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_112-csHR2acdcHR_fda_ciss_src_ceorig_inv-ablation_inv_weights-gpus2_distributed[4-8]
...
export CHECKPOINT_RESUME=("/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/221101_1802_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_0b227/latest.pth" "/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/221101_2304_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_b206d/latest.pth" "/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/221102_0536_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_e9639/latest.pth" "/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/221102_0553_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_1722b/latest.pth" "/cluster/work/cvl/csakarid/results/CISS/local-exp"${EXP_ID}"/221102_0655_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_ceorig_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_7a599/latest.pth")
