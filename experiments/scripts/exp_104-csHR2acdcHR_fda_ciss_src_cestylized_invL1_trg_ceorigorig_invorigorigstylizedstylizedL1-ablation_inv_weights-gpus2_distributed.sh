...
#BSUB -o ../logs/exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-01-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-01-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed[1-4]
