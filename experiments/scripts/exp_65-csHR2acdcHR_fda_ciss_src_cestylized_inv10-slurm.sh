...
#SBATCH --output=../logs/exp_65-csHR2acdcHR_fda_diss_src_cestylized_inv10-slurm-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_65-csHR2acdcHR_fda_diss_src_cestylized_inv10-slurm-01.e
#
