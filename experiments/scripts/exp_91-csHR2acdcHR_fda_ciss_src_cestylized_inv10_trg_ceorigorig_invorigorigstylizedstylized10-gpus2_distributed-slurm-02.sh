...
#SBATCH --output=../logs/exp_91-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_91-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_91-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm
#
# Specify dependency.
...
# Run the experiment.
python -m torch.distributed.launch --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_port=29501 run_experiments.py --exp ${EXP_ID} --seed-to-resume-from ${SEED_TO_RESUME_FROM}
