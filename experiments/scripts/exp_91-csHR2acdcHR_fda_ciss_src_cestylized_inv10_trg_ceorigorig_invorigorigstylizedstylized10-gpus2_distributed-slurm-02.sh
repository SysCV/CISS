...
#SBATCH --output=../logs/exp_91-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_91-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_91-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm
#
# Specify dependency.
