...
#SBATCH --output=../logs/exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCvalall.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCvalall.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCvalall
