...
#SBATCH --output=../logs/exp_108-csHR2acdcHR_fda_ciss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_108-csHR2acdcHR_fda_ciss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_108-csHR2acdcHR_fda_ciss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm
