...
#BSUB -o ../logs/exp_72-csHR2acdcHR_960_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-02-01.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_72-csHR2acdcHR_960_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-02-01.e
#
# Specify jobname.
#BSUB -J exp_72-csHR2acdcHR_960_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-02-01
