...
#SBATCH --output=../logs/exp_87-csHR2acdcHR_fda_ciss_src_cestylized_inv10-gpus2_distributed-slurm-33-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_87-csHR2acdcHR_fda_ciss_src_cestylized_inv10-gpus2_distributed-slurm-33-01.e
#
