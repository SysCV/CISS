...
#BSUB -o ../logs/exp_101-csHR2darkzurichHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-01-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_101-csHR2darkzurichHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-01-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_101-csHR2darkzurichHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed[1-10]
