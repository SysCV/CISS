...
#BSUB -o ../logs/exp_113-csHR2acdcHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_113-csHR2acdcHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_113-csHR2acdcHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_cestylizedstylized-gpus2_distributed
