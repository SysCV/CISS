...
#SBATCH --output=../logs/exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCtestall.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCtestall.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_51-csHR2acdcHR_fda_ciss_src_cestylized-slurm-test_ACDCtestall
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/CISS/local-exp51/220911_0247_csHR2acdcHR_1024x1024_dacs_a999_fdthings_ciss_src_cestylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s1_813de"
