...
#SBATCH --output=../logs/exp_100-csHR2darkzurichHR_fda_diss_src_cestylized-slurm.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_100-csHR2darkzurichHR_fda_diss_src_cestylized-slurm.e
#
