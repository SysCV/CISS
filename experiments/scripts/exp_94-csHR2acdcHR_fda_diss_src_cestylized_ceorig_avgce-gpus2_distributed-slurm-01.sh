...
#SBATCH --output=../logs/exp_94-csHR2acdcHR_fda_diss_src_cestylized_ceorig_avgce-gpus2_distributed-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_94-csHR2acdcHR_fda_diss_src_cestylized_ceorig_avgce-gpus2_distributed-slurm-01-01.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_94-csHR2acdcHR_fda_diss_src_cestylized_ceorig_avgce-gpus2_distributed-slurm
#
# Specify dependency.
