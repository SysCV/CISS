...
#SBATCH --output=../logs/exp_126-csHR2acdcHR_reinhard_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-02-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_126-csHR2acdcHR_reinhard_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-02-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_126-csHR2acdcHR_reinhard_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-02
