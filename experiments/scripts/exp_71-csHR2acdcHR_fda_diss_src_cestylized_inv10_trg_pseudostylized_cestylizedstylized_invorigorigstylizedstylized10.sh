...
#BSUB -o ../logs/exp_71-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized10.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_71-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized10.e
