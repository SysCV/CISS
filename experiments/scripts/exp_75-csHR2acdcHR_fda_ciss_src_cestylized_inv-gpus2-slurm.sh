...
#SBATCH --output=../logs/exp_75-csHR2acdcHR_fda_ciss_src_cestylized_inv-gpus2-slurm-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_75-csHR2acdcHR_fda_ciss_src_cestylized_inv-gpus2-slurm-02.e
#
