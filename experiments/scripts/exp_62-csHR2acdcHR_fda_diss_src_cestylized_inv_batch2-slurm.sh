...
#SBATCH --output=../logs/exp_62-csHR2acdcHR_fda_diss_src_cestylized_inv_batch2-slurm-03.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_62-csHR2acdcHR_fda_diss_src_cestylized_inv_batch2-slurm-03.e
#
