...
#SBATCH --output=../logs/exp_53-csHR2acdcHR_fda_ciss_src_cestylized_inv-slurm-05.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_53-csHR2acdcHR_fda_ciss_src_cestylized_inv-slurm-05.e
#
