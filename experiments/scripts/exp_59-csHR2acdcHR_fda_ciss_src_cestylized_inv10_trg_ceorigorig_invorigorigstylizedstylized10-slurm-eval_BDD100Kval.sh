...
#SBATCH --output=../logs/exp_59-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-slurm-eval_BDD100Kval.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_59-csHR2acdcHR_fda_ciss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-slurm-eval_BDD100Kval.e
#
