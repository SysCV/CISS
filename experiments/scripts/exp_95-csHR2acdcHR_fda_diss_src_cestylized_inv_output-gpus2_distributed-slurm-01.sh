...
#SBATCH --output=../logs/exp_95-csHR2acdcHR_fda_diss_src_cestylized_inv_output-gpus2_distributed-slurm-05-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_95-csHR2acdcHR_fda_diss_src_cestylized_inv_output-gpus2_distributed-slurm-05-01.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_95-csHR2acdcHR_fda_diss_src_cestylized_inv_output-gpus2_distributed-slurm
#
# Specify dependency.
