...
#SBATCH --output=../logs/exp_137-csHR2acdcHR_fda_ciss_src_ceorig_inv_output-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_137-csHR2acdcHR_fda_ciss_src_ceorig_inv_output-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_137-csHR2acdcHR_fda_ciss_src_ceorig_inv_output-slurm
