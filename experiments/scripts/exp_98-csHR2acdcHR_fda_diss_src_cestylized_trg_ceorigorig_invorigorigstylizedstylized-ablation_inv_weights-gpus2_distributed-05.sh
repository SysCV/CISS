...
#BSUB -o ../logs/exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-04-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-04-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed[4-10]
