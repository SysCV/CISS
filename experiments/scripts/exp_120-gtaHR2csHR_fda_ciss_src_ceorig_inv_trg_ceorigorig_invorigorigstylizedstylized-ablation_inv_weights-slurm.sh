...
#SBATCH --output=../logs/exp_120-gtaHR2csHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_120-gtaHR2csHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-%a.e
#
