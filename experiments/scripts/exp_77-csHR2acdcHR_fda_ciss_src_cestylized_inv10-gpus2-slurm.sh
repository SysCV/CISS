...
#SBATCH --output=../logs/exp_77-csHR2acdcHR_fda_ciss_src_cestylized_inv10-gpus2-slurm-07.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_77-csHR2acdcHR_fda_ciss_src_cestylized_inv10-gpus2-slurm-07.e
#
