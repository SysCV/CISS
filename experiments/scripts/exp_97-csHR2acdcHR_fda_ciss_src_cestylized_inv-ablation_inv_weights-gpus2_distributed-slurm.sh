...
#SBATCH --output=../logs/exp_97-csHR2acdcHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_97-csHR2acdcHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_97-csHR2acdcHR_fda_ciss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-slurm
