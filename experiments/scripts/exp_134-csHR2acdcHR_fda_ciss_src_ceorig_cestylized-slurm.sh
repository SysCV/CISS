...
#SBATCH --output=../logs/exp_134-csHR2acdcHR_fda_diss_src_ceorig_cestylized-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_134-csHR2acdcHR_fda_diss_src_ceorig_cestylized-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_134-csHR2acdcHR_fda_diss_src_ceorig_cestylized-slurm
