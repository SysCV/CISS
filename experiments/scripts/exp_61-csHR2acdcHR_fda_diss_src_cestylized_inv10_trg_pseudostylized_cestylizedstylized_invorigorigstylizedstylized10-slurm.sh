...
#SBATCH --output=../logs/exp_61-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized10-slurm.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_61-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_pseudostylized_cestylizedstylized_invorigorigstylizedstylized10-slurm.e
#
