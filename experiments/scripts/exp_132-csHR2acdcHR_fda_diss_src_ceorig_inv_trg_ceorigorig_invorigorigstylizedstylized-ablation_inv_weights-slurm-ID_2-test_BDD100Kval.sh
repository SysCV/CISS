...
#SBATCH --output=../logs/exp_132-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-2-test_BDD100Kval.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_132-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-2-test_BDD100Kval.e
#
...
export TAR_TARGET_DATASET="/cluster/work/cvl/csakarid/data/BDD100K/BDD100K.tar.gz"
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp132/230303_1908_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_9fcab"
export CONFIG_FILE="${TEST_ROOT}/*${TEST_ROOT: -1}_test_bdd100k.json"
export CHECKPOINT_FILE="${TEST_ROOT}/latest.pth"
export SHOW_DIR="${TEST_ROOT}/BDD100K_val/preds"
export TRAINIDS_DIR="${TEST_ROOT}/BDD100K_val/labelTrainIds"
