...
#SBATCH --output=../logs/exp_99-csHR2darkzurichHR_hrda-slurm-test_DarkZurichtest.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_99-csHR2darkzurichHR_hrda-slurm-test_DarkZurichtest.e
#
