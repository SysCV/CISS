...
#SBATCH --output=../logs/exp_76-csHR2acdcHR_fda_ciss_src_cestylized_ceorig_inv-gpus2-slurm-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_76-csHR2acdcHR_fda_ciss_src_cestylized_ceorig_inv-gpus2-slurm-01.e
#
