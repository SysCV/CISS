...
#SBATCH --output=../logs/exp_100-csHR2darkzurichHR_fda_diss_src_cestylized-slurm-test_DarkZurichtest.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_100-csHR2darkzurichHR_fda_diss_src_cestylized-slurm-test_DarkZurichtest.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp100/221024_0519_csHR2dzurHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_2c497"
