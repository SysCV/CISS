...
#SBATCH --output=../logs/exp_118-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_invorigorigstylizedstylized-ablation_trg_ce-gpus2_distributed-slurm-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_118-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_invorigorigstylizedstylized-ablation_trg_ce-gpus2_distributed-slurm-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_118-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_invorigorigstylizedstylized-ablation_trg_ce-gpus2_distributed-slurm
