...
#BSUB -o ../logs/exp_66-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-01.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_66-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-01.e
