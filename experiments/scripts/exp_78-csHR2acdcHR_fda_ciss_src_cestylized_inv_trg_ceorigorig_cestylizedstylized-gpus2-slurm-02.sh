...
#SBATCH --output=../logs/exp_78-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2-slurm-01-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_78-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2-slurm-01-02.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_78-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-gpus2-slurm
#
# Specify dependency.
...
export CHECKPOINT_RESUME="/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/220921_1830_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s2_7838b/latest.pth"
