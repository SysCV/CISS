...
#BSUB -o ../logs/exp_108-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-02-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_108-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-02-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_108-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed[1-7]
