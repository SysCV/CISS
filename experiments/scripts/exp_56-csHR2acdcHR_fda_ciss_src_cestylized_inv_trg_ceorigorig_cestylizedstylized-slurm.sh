...
#SBATCH --output=../logs/exp_56-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-slurm.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_56-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_cestylizedstylized-slurm.e
#
