...
#SBATCH --output=../logs/exp_135-csHR2darkzurichHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-02-2-test_DarkZurichtest.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_135-csHR2darkzurichHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-02-2-test_DarkZurichtest.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp135/230306_1118_csHR2dzurHR_1024x1024_dacs_a999_fdthings_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s2_1f3f5"
export CONFIG_FILE="${TEST_ROOT}/*${TEST_ROOT: -1}.json"
export CHECKPOINT_FILE="${TEST_ROOT}/iter_28000_saved.pth"
