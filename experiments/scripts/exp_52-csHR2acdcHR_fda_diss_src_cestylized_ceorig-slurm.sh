...
#SBATCH --output=../logs/exp_52-csHR2acdcHR_fda_diss_src_cestylized_ceorig-slurm-02.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_52-csHR2acdcHR_fda_diss_src_cestylized_ceorig-slurm-02.e
#
