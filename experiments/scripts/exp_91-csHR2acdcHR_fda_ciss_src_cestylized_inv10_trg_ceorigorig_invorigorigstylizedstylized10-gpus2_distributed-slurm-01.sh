...
#SBATCH --output=../logs/exp_91-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_91-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-gpus2_distributed-slurm-03-01.e
#
