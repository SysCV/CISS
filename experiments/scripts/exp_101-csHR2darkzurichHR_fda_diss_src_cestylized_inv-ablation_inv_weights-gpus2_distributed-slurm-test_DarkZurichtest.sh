...
#SBATCH --output=../logs/exp_101-csHR2darkzurichHR_fda_diss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-slurm-test_DarkZurichtest.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_101-csHR2darkzurichHR_fda_diss_src_cestylized_inv-ablation_inv_weights-gpus2_distributed-slurm-test_DarkZurichtest.e
#
...
export TEST_ROOT="/cluster/work/cvl/csakarid/results/DISS/local-exp101/221023_0510_csHR2dzurHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_inv_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_29398"
