...
#SBATCH --output=../logs/exp_141-cityscapesHR2acdcrefHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_141-cityscapesHR2acdcrefHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_141-cityscapesHR2acdcrefHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm
...
export TAR_TARGET_DATASET="/cluster/work/cvl/csakarid/data/ACDC/ACDC_ref_splits.tar.gz"
