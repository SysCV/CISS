...
#SBATCH --output=../logs/exp_54-csHR2acdcHR_fda_ciss_src_cestylized_ceorig_inv-slurm-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_54-csHR2acdcHR_fda_ciss_src_cestylized_ceorig_inv-slurm-01.e
#
