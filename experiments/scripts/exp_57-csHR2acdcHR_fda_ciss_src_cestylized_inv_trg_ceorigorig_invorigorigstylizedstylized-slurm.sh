...
#SBATCH --output=../logs/exp_57-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-06.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_57-csHR2acdcHR_fda_ciss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-slurm-06.e
#
