...
#SBATCH --output=../logs/exp_132-csHR2acdcHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-05-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_132-csHR2acdcHR_fda_ciss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-05-%a.e
#
