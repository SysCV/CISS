...
#SBATCH --output=../logs/exp_77-csHR2acdcHR_fda_diss_src_cestylized_inv10-gpus2-slurm-07-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_77-csHR2acdcHR_fda_diss_src_cestylized_inv10-gpus2-slurm-07-01.e
#
