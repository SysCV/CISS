...
#SBATCH --output=../logs/exp_79-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-gpus2-slurm-01-01.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_79-csHR2acdcHR_fda_diss_src_cestylized_inv_trg_ceorigorig_invorigorigstylizedstylized-gpus2-slurm-01-01.e
#
