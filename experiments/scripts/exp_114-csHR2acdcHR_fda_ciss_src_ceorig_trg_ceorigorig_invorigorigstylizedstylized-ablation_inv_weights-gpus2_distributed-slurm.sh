...
#SBATCH --output=../logs/exp_114-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_114-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-01-%a.e
#
