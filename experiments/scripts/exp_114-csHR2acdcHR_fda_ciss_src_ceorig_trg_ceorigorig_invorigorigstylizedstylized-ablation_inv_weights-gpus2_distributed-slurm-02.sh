...
#SBATCH --output=../logs/exp_114-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-02-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_114-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm-02-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_114-csHR2acdcHR_fda_diss_src_ceorig_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-slurm
