...
#BSUB -o ../logs/exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-07-%I.o
#
# Specify file for logging standard error.
#BSUB -e ../logs/exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed-07-%I.e
#
# Specify jobname and range of tasks for job array.
#BSUB -J exp_98-csHR2acdcHR_fda_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-gpus2_distributed[4-6]
...
export CHECKPOINT_RESUME=("/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/221014_1028_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_08029/latest.pth" "/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/221014_1203_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_675b3/latest.pth" "/cluster/work/cvl/csakarid/results/DISS/local-exp"${EXP_ID}"/221014_1203_csHR2acdcHR_1024x1024_dacs_a999_fdthings_diss_src_cestylized_trg_ceorigorig_invorigorigstylizedstylized_rcs001-20_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_34d64/latest.pth")
