...
#SBATCH --output=../logs/exp_59-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-slurm-07.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_59-csHR2acdcHR_fda_diss_src_cestylized_inv10_trg_ceorigorig_invorigorigstylizedstylized10-slurm-07.e
#
