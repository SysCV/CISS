...
#SBATCH --output=../logs/exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm-01-%a.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm-01-%a.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname and range of tasks for job array.
#SBATCH --job-name=exp_104-csHR2acdcHR_fda_diss_src_cestylized_invL1_trg_ceorigorig_invorigorigstylizedstylizedL1-ablation_inv_weights-gpus2_distributed-slurm
