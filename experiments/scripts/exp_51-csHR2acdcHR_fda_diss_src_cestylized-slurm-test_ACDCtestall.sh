...
#SBATCH --output=../logs/exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm-test_ACDCtestall.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm-test_ACDCtestall.e
#
# Specify open mode for log files.
#SBATCH --open-mode=append
#
# Specify jobname.
#SBATCH --job-name=exp_51-csHR2acdcHR_fda_diss_src_cestylized-slurm-test_ACDCtestall
