...
#SBATCH --output=../logs/exp_132-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-2-test_BDD100Knight.o
#
# Specify file for logging standard error.
#SBATCH --error=../logs/exp_132-csHR2acdcHR_fda_diss_src_ceorig_inv_trg_ceorigorig_invorigorigstylizedstylized-ablation_inv_weights-slurm-01-2-test_BDD100Knight.e
#
